...
function prepareDataInputOnTbl(rowCount) {
    // get data input
    var objItemInput = {};
    // put data to object
    objItemInput = {
        'inputFullname': document.getElementById("txtFullnameTbl" + rowCount),
        'inputAddress': document.getElementById("txtAddressTbl" + rowCount)
    }
    return objItemInput;
}
...
function addDataOnTableBasic(rowCount, findIndex) {
    ...
    btnEdit.setAttribute("onclick", "editInForm('"+ findIndex +"', '"+ rowCount +"')");
 ...
 */
function editInForm(findIndex, rowCount) { 
    // hide button submit form
    document.getElementById("btnEdit" + rowCount).style.display = "none";
    ...
    btnSaveOnTbl.setAttribute("onclick", "btnSave('"+ findIndex +"', '"+ rowCount +"')");
